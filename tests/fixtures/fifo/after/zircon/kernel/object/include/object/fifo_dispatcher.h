...
extern "C" {
zx_status_t rust_fifo_dispatcher_write_from_user(FifoDispatcher* fifo, size_t elem_size,
                                                 const uint8_t* ptr, size_t count, size_t* actual);
zx_status_t rust_fifo_dispatcher_read_to_user(FifoDispatcher* fifo, size_t elem_size, uint8_t* ptr,
